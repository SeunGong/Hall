...
//	htim8.State = HAL_TIM_STATE_READY;
	HAL_TIM_IC_Start_DMA(&htim8, TIM_CHANNEL_3, (uint32_t*) Pulse3, 1);
  ...
  /* USER CODE BEGIN WHILE */
	while (1) {
		...
		/*		uint8_t hall = 0;
		 ...
		 hall2 = HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_5);
		 hall3 = HAL_GPIO_ReadPin(GPIOE, GPIO_PIN_6);
		 hall = 4 * hall1 + 2 * hall2 + 1 * hall3;
		 if (hall != prevalue && hall == inithall) {
		 num++;
		 if (num % 9 == 0) {
		 cycle++;
		 printf("cycle : %d Hall : %d \r\n", cycle, hall);
		 }
		 }
		 prevalue = hall;*/
	}
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, Break_Pin|Reverse_Pin|Pulse1_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : Break_Pin Reverse_Pin Pulse1_Pin */
  GPIO_InitStruct.Pin = Break_Pin|Reverse_Pin|Pulse1_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pins : Hall2_Pin Hall3_Pin */
  GPIO_InitStruct.Pin = Hall2_Pin|Hall3_Pin;
